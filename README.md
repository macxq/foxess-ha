...
#### Auxiliary notes:
- `username & password` are exactly as you enter them in the FoxESS app or the cloud - note they are case specific and reserved characters shouldn't be used such as '!'
